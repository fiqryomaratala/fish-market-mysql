  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-slate-200 bg-white shadow-lg shadow-slate-200/40">
        <div className="hidden grid-cols-[110px_1.2fr_1.2fr_1.1fr_0.9fr_1fr_0.9fr_1fr_140px] gap-4 border-b border-slate-100 px-6 py-4 lg:grid">
        ...
        <div className="space-y-4 p-4">
          {Array.from({ length: 6 }).map((_, index) => (
            <div
              key={index}
              className="grid animate-pulse gap-4 rounded-xl border border-slate-100 p-4 lg:grid-cols-[110px_1.2fr_1.2fr_1.1fr_0.9fr_1fr_0.9fr_1fr_140px] lg:items-center"
            >
