...
func NewHarvestService(harvestRepo repositories.HarvestRepository, batchRepo repositories.FishBatchRepository, inventoryService InventoryService) HarvestService {
